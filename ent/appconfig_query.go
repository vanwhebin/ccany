...
func (acq *AppConfigQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (acq *AppConfigQuery) FirstIDX(ctx context.Context) string {
...
func (acq *AppConfigQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (acq *AppConfigQuery) OnlyIDX(ctx context.Context) string {
...
func (acq *AppConfigQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (acq *AppConfigQuery) IDsX(ctx context.Context) []string {
	ids, err := acq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (acq *AppConfigQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(appconfig.Table, appconfig.Columns, sqlgraph.NewFieldSpec(appconfig.FieldID, field.TypeString))
	_spec.From = acq.sql
