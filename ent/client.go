...
func (c *AppConfigClient) UpdateOneID(id string) *AppConfigUpdateOne {
...
func (c *AppConfigClient) DeleteOneID(id string) *AppConfigDeleteOne {
...
func (c *AppConfigClient) Get(ctx context.Context, id string) (*AppConfig, error) {
	return c.Query().Where(appconfig.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AppConfigClient) GetX(ctx context.Context, id string) *AppConfig {
...
// UpdateOneID returns an update builder for the given id.
func (c *RequestLogClient) UpdateOneID(id string) *RequestLogUpdateOne {
...
// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *RequestLogClient) DeleteOneID(id string) *RequestLogDeleteOne {
...
func (c *RequestLogClient) Get(ctx context.Context, id string) (*RequestLog, error) {
	return c.Query().Where(requestlog.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *RequestLogClient) GetX(ctx context.Context, id string) *RequestLog {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
type (
	hooks struct {
		AppConfig, Channel, RequestLog, User []ent.Hook
	}
	inters struct {
		AppConfig, Channel, RequestLog, User []ent.Interceptor
	}
)
